...
**22.9.2026 — סטייה אחת מהמילה-במילה, בכוונה.** הבעלים קבע (מפרט §0.1) שהשם נכתב
**שלום תקוה**, ו' אחת, בכל מקום — כולל מקורות. ויקיפועל כותבת אותו בשתיים, ולכן שורה אחת
כאן, וכל המופעים בארבע ההורדות הגולמיות ב-`content/raw/`, תוקנו לאיות שלו (ההפרש בכל קובץ
הוא בדיוק 2 בייטים למופע — ו' אחת ב-UTF-8 — ולא שום דבר אחר). הטביעה למעלה מתארת את הקובץ
כפי שנקרא **לפני** התיקון. ייבוא חוזר של ויקיפועל יביא את האיות הישן, והוא מתוקן בנקודת
ההתאמה (`lib/canon/spelling.ts`) ולא נשמר כשם חלופי (כלל 7).
