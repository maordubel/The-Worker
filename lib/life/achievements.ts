...
export const ACHIEVEMENTS: readonly Achievement[] = [
  ...
  },
  {
    ...
    waitingHe:
      'אין עדיין מנגנון של סיכום מחדש לפני המועד. שום סצנה לא מציעה לשנות התחייבות מראש, ולכן ' +
      '`promise_renegotiated` לא נרשם באף פרק.',
  },
  {
    id: 'ACH_SHIRT_WORK',
  ...
  },
  {
    ...
    waitingHe: 'אין עדיין משימת אימות מקורות בשום פרק, ולכן `verified_report` לא נרשם אף פעם.',
  },
  {
    id: 'ACH_CORRECT',
    ...
    waitingHe: 'אין עדיין פרסום בתוך העולם שאפשר לתקן, ולכן `public_correction` לא נרשם אף פעם.',
  },
  {
    id: 'ACH_GAVE',
    titleHe: 'המקום שנתתי',
    ...
    waitingHe:
      'העברת כרטיס קיימת בעולם, אבל אף סצנה לא רושמת שהמקבל השתמש בו באירוע — חסר `ticket_used`.',
  },
  {
    id: 'ACH_RELIABLE',
    titleHe: 'ארבע הבטחות',
    ...
    waitingHe:
      'בתוכן קיימות שתי הבטחות בלבד (`promise:rachel-army`, `life:promise:g4`) ואף אחת מהן אינה ' +
      'רושמת `promise_kept`. ארבע הבטחות בשני פרקים אינן ניתנות להשגה היום.',
  },
  {
    id: 'ACH_REPAIR',
    titleHe: 'חזרתי לדבר',
    ...
    waitingHe:
      'תקריות והפרות נרשמות היום כ-`relationshipMemory` ולא כראיה, ואין סצנת תיקון שמסכמת ' +
      'פיוס. `repair_completed` לא נרשם באף פרק.',
  },
  {
    id: 'ACH_TEAM',
    ...
    waitingHe:
      'הארגון הקבוצתי קיים בסיפור (הפנקס, ההסעה, `owe:shachor`) אבל אף אחד לא מתחייב לאנשים ' +
      'בשמם, ולכן `group_delivered` לא נרשם.',
  },
  {
    id: 'ACH_WRITE',
    ...
    waitingHe: 'מסלול העיתונאי עדיין נבנה. אין פרסום בתוך העולם ולכן אין `publication_proof`.',
  },
  {
    id: 'ACH_CREATE',
    titleHe: 'שרים את זה',
    ...
    waitingHe: 'אין עדיין מנגנון יצירה, ולכן `creation_proof` ו-`crowd_use_proof` לא נרשמים.',
  },
  {
    id: 'ACH_BALANCE',
    ...
    waitingHe:
      '`debt` קיים במצב ו-`owe:` קיים בדגלים, אבל אין סצנה שסוגרת התחייבות כספית ורושמת ' +
      '`debt_settled`. שתי פרעונות בשני מועדים אינן ניתנות להשגה היום.',
  },
  {
    id: 'ACH_FIRST_AWAY',
  ...
  },
  {
    ...
    waitingHe: 'מסלולי החיים (`lib/life/routes.ts`) נבנים במקביל. שום סצנה לא מרימה עדיין את דגל השיא.',
  },
  {
    id: 'ACH_JOURNALIST',
    titleHe: 'הטור שלי',
  ...
  },
  {
    ...
    waitingHe: 'מסלולי החיים (`lib/life/routes.ts`) נבנים במקביל, ואין עדיין חוזה בעלות בתוך העולם.',
  },
  {
    id: 'ACH_ARTIST',
    ...
    waitingHe: 'מסלולי החיים (`lib/life/routes.ts`) נבנים במקביל, ואין עדיין מנגנון יצירה.',
  },
  {
    id: 'ACH_FOUNDER',
    ...
    waitingHe:
      'מסלולי החיים (`lib/life/routes.ts`) נבנים במקביל. חלון ההקמה של הפועל אוסישקין הוא 2007, ' +
      'אחרי הפרק האחרון שנבנה.',
  },
  {
    id: 'ACH_ROADS',
