...
export const ACHIEVEMENTS: readonly Achievement[] = [
  ...
  },
  {
    ...
    waitingHe:
      'שיא המסלול נלקח בשיחה — `acceptEvents` מרים את הדגל וההזמנה מגיעה בחדר שפרק נפתח בו. ' +
      'מה שעוצר הוא הגיל: "מנהיג יציע" נפתח ב-25, והפרק האחרון שנבנה הוא 2000, כלומר תקרה של 22. ' +
      'זה מחושב מרשימת הפרקים (`stageOutOfReachFor`) ולא מוקלד — פרק שאחרי 2000 יזיז אותו בלי לגעת בשורה.',
  },
  {
    id: 'ACH_JOURNALIST',
    titleHe: 'הטור שלי',
    ...
    waitingHe:
      'שיא המסלול נלקח בשיחה — `acceptEvents` מרים את הדגל וההזמנה מגיעה בחדר שפרק נפתח בו. ' +
      'מה שעוצר הוא הגיל: "בעל מדור" נפתח ב-25, והפרק האחרון שנבנה הוא 2000, כלומר תקרה של 22. ' +
      'זה מחושב מרשימת הפרקים (`stageOutOfReachFor`) ולא מוקלד — פרק שאחרי 2000 יזיז אותו בלי לגעת בשורה.',
  },
  {
    id: 'ACH_OWNER',
    ...
    waitingHe:
      'שני חסמים, ושניהם נמדדים: "שותף בעלות" נפתח בגיל 30 והתקרה היום היא 22 ' +
      '(`stageOutOfReachFor`), ובנוסף אין עדיין חוזה בעלות בתוך העולם — `ownership_contract` ' +
      'לא נרשם באף סצנה.',
  },
  {
    id: 'ACH_ARTIST',
    ...
    waitingHe:
      'מנגנון היצירה כבר קיים — `creation_proof` נרשם על הקצב ועל השלט (ראו `ACH_CREATE`). ' +
      'מה שנשאר הוא הגיל: "יוצר מזוהה" נפתח ב-25 והתקרה היום היא 22, מחושבת מרשימת הפרקים.',
  },
  {
    id: 'ACH_FOUNDER',
  ...
  },
  {
    ...
    waitingHe:
      'שיא המסלול נלקח בשיחה — `acceptEvents` מרים את הדגל וההזמנה מגיעה בחדר שפרק נפתח בו. ' +
      'מה שעוצר הוא הגיל: "מארגן נסיעות מוכר" נפתח ב-25, והפרק האחרון שנבנה הוא 2000, כלומר תקרה של 22. ' +
      'זה מחושב מרשימת הפרקים (`stageOutOfReachFor`) ולא מוקלד — פרק שאחרי 2000 יזיז אותו בלי לגעת בשורה.',
  },
  {
    id: 'ACH_FIRST_ERA',
