...
export const PASSAGE_1993: PassageObject[] = [
  ...
  },
  {
    ...
    // הפנקס הזה הוא מניפסט ההסעה — תאריכים, שעות יציאה ושמות — ולכן הוא של מישל.
    // הפנקס של סוקו הוא דבר אחר לגמרי: הוא התיעוד ההיסטורי, "שיהיה מישהו שיודע מה
    // באמת היה" (1993-galil), ושני הפנקסים לא מתערבבים.
    afterHe: 'מישל החזיר לך אותו והוסיף עמוד. הכתב שלך בו עכשיו, בשורה השנייה.',
  },
  {
    id: 'laces',
    labelHe: 'הנעליים',
