    ...
    branches: [
      {
        ...
        lines: [
          { who: 'בעל הקיוסק', text: 'קנית עיתון, קרא עיתון. הטבלה לא משתנה מלהסתכל עליה.' },
          { who: 'בעל הקיוסק', text: 'ואם אתה שואל — יבנה בבית. בבית לא מפסידים במחזור אחרון. אף אחד.' },
        ],
      },
      {
        when: { minAgorot: 120 },
        lines: [
          { who: 'בעל הקיוסק', text: 'עיתון? מאה ועשרים. יש שם טבלה, ויש שם עמוד שלם שמסביר למה זה לא פשוט.' },
        ],
        choices: [
          {
            id: 'buy',
      ...
      {
        lines: [
          { who: 'בעל הקיוסק', text: 'בלי כסף אין עיתון. אבל אני אגיד לך בחינם: יבנה בבית.' },
