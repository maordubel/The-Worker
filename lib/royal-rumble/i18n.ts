...
const COPY = {
  ...
  kickoff: 'השריקה. רויאל ראמבל יוצא לדרך.', opponentTitle: 'חמש דלתות. חמישה יריבים.',
  ...
  ruleOpponent: 'היריבה נקבעת מראש — אין התאמה לבחירות שלך.', challengeTitle: 'תן לחבר בדיוק את אותו ראמבל.',
  challengeBody: 'אותם 15 מועמדים, אותה יריבה, אותו תקציב. רק ההחלטות משתנות. עכשיו אפשר להתווכח על החמישייה — לא על ההגרלה.',
  challengeShare: 'שלח את הראמבל', challengeCopied: 'הלינק הועתק', challengeShared: 'נשלח. עכשיו שיבנה.',
  ...
  kitSeason: 'חולצת {season}', kitArchive: 'חולצת משחק מהארכיון', kitNearest: 'החולצה הקרובה ביותר לתקופת השחקן מתוך המאגר הקיים.',
