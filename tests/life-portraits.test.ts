...
const NO_PLATE_YET: ReadonlySet<string> = new Set([
  ...
  'מוכר הגרעינים',
  /**
   * בתיה — שורה ברישום מאז 5.9.2026, **בלי `portraitSet`**, וזו ההוראה של הביבליה
   * ולא פספוס: דמות היא שורה לפני שהיא פנים (כלל 58). היא מדברת שורה אחת ב-`H02`
   * (*"געגועים לא נותנים פטור משמש"*), והרישום כאן הוא מה שמונע ממנה לקבל בטעות
   * פלייט של מישהו אחר — שזו התקלה שכלל 67 נכתב עליה.
   */
  'בתיה',
  /**
   ...
   * בחיים שבהם פוגי השאיר את הנעליים ריקות. אותה סיבה כמו בתיה: עדיף בלי פנים מאשר עם
