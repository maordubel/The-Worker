...
export const STREETS: Record<string, Street> = {
  ...
  // **הרחוב שנבנה משתי פנורמות מלאות.** לא שני תצלומים שמסתכלים לאותו כיוון, אלא שני
  // גלילים שלמים במרחק שישה מטר זה מזה: בכל נקודה על הקטע אפשר גם ללכת קדימה וגם
  // להסתובב סביב עצמך במעגל שלם, ובשום מקום אין קצה פריים.
  bloomfield360: {
    nameHe: 'בלומפילד — לאורך החזית, 360°',
    noteHe: 'שתי תחנות מצולמות, שישה מטר זו מזו, מאותו גובה ובאותו אופק.',
    stops: [
      { pano: 'panoBloom24', at: 0 },
      { pano: 'panoBloom18', at: 6 },
    ],
  },
  bloomfield: {
